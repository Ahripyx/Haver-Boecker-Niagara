...
namespace Haver_Boecker_Niagara.Controllers
{
    public class MachineController : ElephantController
    {
        ...
        public async Task<IActionResult> Create([Bind("MachineID,SerialNumber,InternalPONumber,MachineSize,MachineClass,MachineSizeDesc,SalesOrderID")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MachineID,SerialNumber,InternalPONumber,MachineSize,MachineClass,MachineSizeDesc,SalesOrderID")] Machine machine)
        {
